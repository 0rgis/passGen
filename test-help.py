...
def main():
    ...
    parser.add_argument('-l', '--length', type=int, help='Length of the generated passwords', required=True)
    parser.add_argument('-u', '--min_uppercase', type=int, help='Minimum number of uppercase letters', default=1)
    parser.add_argument('-w', '--min_lowercase', type=int, help='Minimum number of lowercase letters', default=1)
    parser.add_argument('-d', '--min_digits', type=int, help='Minimum number of digits', default=1)
    parser.add_argument('-s', '--min_symbols', type=int, help='Minimum number of symbols', default=1)
    ...
    generate_and_save_passwords(args.num_passwords, args.length, args.min_uppercase, args.min_lowercase, args.min_digits, args.min_symbols, args.ambiguous, args.custom_set, args.file_path)
